// TAPPlay.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CTAPPlayApp, CWinApp)
...
//////////////////////////////////////////////////////////////////////////
// CTAPPlayApp construction

CTAPPlayApp::CTAPPlayApp()
{
...
// The one and only CTAPPlayApp object

CTAPPlayApp theApp;


// CTAPPlayApp initialization

BOOL CTAPPlayApp::InitInstance()
{
...
void CTAPPlayApp::OnReceive(CString& strRecv){
	((CTAPPlayDlg*)m_pMainWnd)->OnReceive(strRecv);
}