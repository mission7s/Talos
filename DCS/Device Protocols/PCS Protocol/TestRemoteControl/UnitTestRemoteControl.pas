...
type
  TForm12 = class(TForm)
    ...
    Label15: TLabel;
    Label16: TLabel;
    LabeledEditRecordSpliceID: TLabeledEdit;
    MaskEditRecordSpliceTime: TMaskEdit;
    MaskEditRecordSpliceDuration: TMaskEdit;
    ButtonSetSCTE35: TButton;
    ButtonGetSCTE35: TButton;
    ...
    procedure ButtonSetSCTE35Click(Sender: TObject);
    procedure ButtonGetSCTE35Click(Sender: TObject);
  private
...
procedure TForm12.ButtonGetSCTE35Click(Sender: TObject);
var
  R: Integer;
  SpliceStartTimecode: String;
  SpliceDurationTimecode: String;
begin
  R := FRecordControlList[ComboBoxRecordDeviceNumber.ItemIndex].GetSCTE35(LabeledEditRecordSpliceID.Text, SpliceStartTimecode, SpliceDurationTimecode);
  LogReceived(Format('ButtonGetSCTE35Click. Result: %d, Timecode: %s, Duration: %s', [R, SpliceStartTimecode, SpliceDurationTimecode]));

  MaskEditRecordSpliceTime.EditText := SpliceStartTimecode;
  MaskEditRecordSpliceDuration.EditText := SpliceDurationTimecode;
end;
...
procedure TForm12.ButtonSetSCTE35Click(Sender: TObject);
var
  R: Integer;
begin
  R := FRecordControlList[ComboBoxRecordDeviceNumber.ItemIndex].SetSCTE35(LabeledEditRecordSpliceID.Text, MaskEditRecordSpliceTime.EditText, MaskEditRecordSpliceDuration.EditText);
  LogReceived(Format('ButtonSetSCTE35Click. Result: %d, id: %s', [R, LabeledEditRecordSpliceID.Text]));
end;
