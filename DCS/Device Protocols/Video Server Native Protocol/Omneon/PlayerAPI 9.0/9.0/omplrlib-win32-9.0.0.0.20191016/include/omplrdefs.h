/**********************************************************************
 ...
 Copyright (c) 1998-2018, Harmonic Inc. All rights reserved.
************************************************************************/
...
public:
    ...
    // unsigned int used here for the sake of playertest, which
    // is build outside omneon infrastructure.
    PlayerId(unsigned int id = forbiddenId) : mId(id) {}
    PlayerId(const PlayerId& id)            : mId(id.mId) {}
...
enum OmPlrRecordStyle {
    ...
    omPlrRecordStyleRdd9,           // Sony Rdd-9 low latency w/377-1 compliant package durations
...
enum OmPlrProResMask {
    omPlrProResProfileMask  = 0xf,
    omPlrProResLineShift    = 4,
    omPlrProResLineMask     = 0x3,
};

enum OmPlrProResPreset {
    omPlrProResPresetUnknown            = 0,
    omPlrProResPreset422_720Line        = (1<<omPlrProResLineShift) | omPlrProResProfile422,
    omPlrProResPreset422_1080Line       = (2<<omPlrProResLineShift) | omPlrProResProfile422,
    omPlrProResPreset422_2160Line       = (3<<omPlrProResLineShift) | omPlrProResProfile422,
    omPlrProResPreset422_LT_720Line     = (1<<omPlrProResLineShift) | omPlrProResProfile422_LT,
    omPlrProResPreset422_LT_1080Line    = (2<<omPlrProResLineShift) | omPlrProResProfile422_LT,
    omPlrProResPreset422_LT_2160Line    = (3<<omPlrProResLineShift) | omPlrProResProfile422_LT,
    omPlrProResPreset422_HQ_720Line     = (1<<omPlrProResLineShift) | omPlrProResProfile422_HQ,
    omPlrProResPreset422_HQ_1080Line    = (2<<omPlrProResLineShift) | omPlrProResProfile422_HQ,
    omPlrProResPreset422_HQ_2160Line    = (3<<omPlrProResLineShift) | omPlrProResProfile422_HQ,
};

#ifdef __cplusplus
inline OmPlrProResPreset encodeProResPreset(OmPlrProResProfile profile,
                                            uint nLines)
{
    switch (profile) {
    case omPlrProResProfile422:
        switch(nLines) {
        case 720:   return omPlrProResPreset422_720Line;
        case 1080:  return omPlrProResPreset422_1080Line;
        case 2160:  return omPlrProResPreset422_2160Line;
        default:    return omPlrProResPresetUnknown;
        }
    case omPlrProResProfile422_LT:
        switch(nLines) {
        case 720:   return omPlrProResPreset422_LT_720Line;
        case 1080:  return omPlrProResPreset422_LT_1080Line;
        case 2160:  return omPlrProResPreset422_LT_2160Line;
        default:    return omPlrProResPresetUnknown;
        }
    case omPlrProResProfile422_HQ:
        switch(nLines) {
        case 720:   return omPlrProResPreset422_HQ_720Line;
        case 1080:  return omPlrProResPreset422_HQ_1080Line;
        case 2160:  return omPlrProResPreset422_HQ_2160Line;
        default:    return omPlrProResPresetUnknown;
        }
    default:
        return omPlrProResPresetUnknown;
    }
}

inline OmPlrProResProfile getProResProfile(OmPlrProResPreset preset)
{
    return OmPlrProResProfile(preset & omPlrProResProfileMask);
}

inline uint getLineCount(OmPlrProResPreset preset)
{
    switch (preset >> omPlrProResLineShift) {
    default:return 0;
    case 1: return 720;
    case 2: return 1080;
    case 3: return 2160;
...
enum OmPlrDnxLineMask {
    omPlrDnxLevelMask   = 0xf,
    omPlrDnxLineShift   = 4,
    omPlrDnxLineMask    = 0xf,

    omPlrDnx_720Line    = 1 << omPlrDnxLineShift,
    omPlrDnx1080Line    = 2 << omPlrDnxLineShift,
    omPlrDnx2160Line    = 3 << omPlrDnxLineShift,
};

enum OmPlrDnxPreset {
    omPlrDnxPresetUnknown       = 0,
    omPlrDnxPreset_LB__1080Line = omPlrDnx1080Line | omPlrDnxLevelLB,
    omPlrDnxPreset_LB__2160Line = omPlrDnx2160Line | omPlrDnxLevelLB,
    omPlrDnxPreset_TR___720Line = omPlrDnx_720Line | omPlrDnxLevelTR,
    omPlrDnxPreset_TR__1080Line = omPlrDnx1080Line | omPlrDnxLevelTR,
    omPlrDnxPreset_SQ___720Line = omPlrDnx_720Line | omPlrDnxLevelSQ,
    omPlrDnxPreset_SQ__1080Line = omPlrDnx1080Line | omPlrDnxLevelSQ,
    omPlrDnxPreset_SQ__2160Line = omPlrDnx2160Line | omPlrDnxLevelSQ,
    omPlrDnxPreset_HQ___720Line = omPlrDnx_720Line | omPlrDnxLevelHQ,
    omPlrDnxPreset_HQ__1080Line = omPlrDnx1080Line | omPlrDnxLevelHQ,
    omPlrDnxPreset_HQ__2160Line = omPlrDnx2160Line | omPlrDnxLevelHQ,
    omPlrDnxPreset_HQX__720Line = omPlrDnx_720Line | omPlrDnxLevelHQX,
    omPlrDnxPreset_HQX_1080Line = omPlrDnx1080Line | omPlrDnxLevelHQX,
    omPlrDnxPreset_HQX_2160Line = omPlrDnx2160Line | omPlrDnxLevelHQX,
};

#ifdef __cplusplus
inline OmPlrDnxPreset encodeDnxPreset(OmPlrDnxLevel profile,
                                      uint height, uint width)
{
    if (width != 0) {
        switch (height) {
        case 720:
            if (profile == omPlrDnxLevelTR) {
                if (width != 960)
                    return omPlrDnxPresetUnknown;
            } else if (width != 1280) {
                return omPlrDnxPresetUnknown;
            }
            break;
        case 1080:
            ...
            break;
        case 2160:
            if (width != 3840) // XXX this is really an RI profile
                return omPlrDnxPresetUnknown;
            break;
        default:
            return omPlrDnxPresetUnknown;
    ...
    switch (profile) {
    case omPlrDnxLevelLB:
        switch(height) {
        case 1080:  return omPlrDnxPreset_LB__1080Line;
        case 2160:  return omPlrDnxPreset_LB__2160Line;
        default:    return omPlrDnxPresetUnknown;
        }
    case omPlrDnxLevelTR:
        switch(height) {
        case 720:   return omPlrDnxPreset_TR___720Line; // width=960
        case 1080:  return omPlrDnxPreset_TR__1080Line; // width=1440
        default:    return omPlrDnxPresetUnknown;
        }
    case omPlrDnxLevelSQ:
        switch(height) {
        case 720:   return omPlrDnxPreset_SQ___720Line;
        case 1080:  return omPlrDnxPreset_SQ__1080Line;
        case 2160:  return omPlrDnxPreset_SQ__2160Line;
        default:    return omPlrDnxPresetUnknown;
        }
    case omPlrDnxLevelHQ:
        switch(height) {
        case 720:   return omPlrDnxPreset_HQ___720Line;
        case 1080:  return omPlrDnxPreset_HQ__1080Line;
        case 2160:  return omPlrDnxPreset_HQ__2160Line;
        default:    return omPlrDnxPresetUnknown;
        }
    case omPlrDnxLevelHQX:
        switch(height) {
        case 720:   return omPlrDnxPreset_HQX__720Line;
        case 1080:  return omPlrDnxPreset_HQX_1080Line;
        case 2160:  return omPlrDnxPreset_HQX_2160Line;
        default:    return omPlrDnxPresetUnknown;
        }
    default:
        return omPlrDnxPresetUnknown;
...
inline OmPlrDnxLevel getDnxLevel(OmPlrDnxPreset preset)
{
    return OmPlrDnxLevel(preset & omPlrDnxLevelMask);
}

inline uint getLineCount(OmPlrDnxPreset preset)
{
    switch ((preset >> omPlrDnxLineShift) << omPlrDnxLineShift) {
    default:return 0;
    case omPlrDnx_720Line: return 720;
    case omPlrDnx1080Line: return 1080;
    case omPlrDnx2160Line: return 2160;
    }
}
#endif // __cplusplus
...
struct OmPlrStatus5A {
    ...
    OmPlrType type;           // what type of player this is (e.g. SDI,
                              // compressed stream, etc.)
    bool    currClipIsCached; // true if the current clip is non-local, but
                              // has been cached locally
};
struct OmPlrStatus5W {
    uint    version;          //
    OmPlrState  state;        // player state
    double  rate;             // player rate
    int     pos;              // player position
...
#ifdef UNICODE
#define OmPlrStatus5 OmPlrStatus5W
#else
#define OmPlrStatus5 OmPlrStatus5A
#endif
