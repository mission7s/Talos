...
uses System.Classes, System.SysUtils, System.SyncObjs, Winapi.Windows,
  UnitDeviceThread, UnitCommons, UnitSerialLouth;

type
  TDeviccePCS = class(TDeviceThread)
  private
    FLouth: TSerialLouth;
  protected
...
constructor TDeviccePCS.Create(ADevice: PDevice);
begin
  inherited Create(ADevice);
  FLouth := TSerialLouth.Create(nil);
end;

destructor TDeviccePCS.Destroy;
begin
  inherited Destroy;
end;

procedure TDeviccePCS.ControlReset;
begin
  inherited;
end;

procedure TDeviccePCS.ControlCommand;
begin
  inherited;
end;

procedure TDeviccePCS.ControlClear;
begin
  try
...
procedure TDeviccePCS.ControlChanged;
//var
...
procedure TDeviccePCS.ControlStart;
var
  R: Integer;
begin
  try
...
procedure TDeviccePCS.ControlStop;
var
  R: Integer;
begin
  try
...
procedure TDeviccePCS.ControlCue;
var
  R: Integer;
  Request: TIDRequest;
...
procedure TDeviccePCS.ControlSchedule;
begin
  inherited;
end;

procedure TDeviccePCS.ControlGetStatus;
begin
  inherited;
end;

function TDeviccePCS.GetStatus: TDeviceStatus;
var
  R: Integer;
  PortStateStatus: TPortStateStatus;
...
function TDeviccePCS.DeviceOpen: Integer;
var
  R: Integer;
  PortStateStatus: TPortStateStatus;
begin
...
function TDeviccePCS.DeviceClose: Integer;
begin
...
function TDeviccePCS.DeviceInit: Integer;
begin
...
{function TDeviccePCS.DCSGetStatus(ABuffer: String): Integer;
const
