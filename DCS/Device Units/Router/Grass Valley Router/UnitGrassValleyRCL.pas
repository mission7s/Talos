...
type
  ...
  public
    ...
    function TakebyLevelIndex(ADstEntry: TFullQualEntry; ALevel: SmallInt; ASrcEntry: TFullQualEntry; ATimeStamp: String = ''): Integer;
...
//  Inc(FSeqNumber);
  ...
  Buffer := Chr(GVR_RCL_SOH) + 'R' + SessionIDStr + MessageIDStr + SeqNumberStr + 'FFFF';
  ...
  Buffer := Buffer + CheckSumStr + Chr(GVR_RCL_EOT);
...
function TGrassValleyRCL.TakebyLevelIndex(ADstEntry: TFullQualEntry; ALevel: SmallInt; ASrcEntry: TFullQualEntry; ATimeStamp: String = ''): Integer;
var
  Buffer: AnsiString;
begin
