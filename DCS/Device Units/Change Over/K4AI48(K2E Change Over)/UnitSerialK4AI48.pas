...
type
  ...
  public
    ...
    function GetSystemStatus(var AModel: String; var ARemote: Word): Integer;     // 0X30
...
begin
  ...
  CheckSum := PACKET_DEST xor PACKET_SRC xor (ADataSize + 4) xor PACKET_TYPE xor CMD_CAT_SEND xor ACMD;
  for I := 1 to ADataSize do
