...
type
  ...
  public
    ...
    property LastResult: HRESULT read FLastResult write FLastResult;
...
begin
  FEngine.FLastResult := S_OK;
  SetEvent(FEngine.FSyncMsgEvent);
...
begin
  FEngine.FLastResult := GetLastResult(bSuccess);

  FEngine.FLastScene := pScene;
  FEngine.FLastTotalCount := TotalCount;
...
begin
  ...
  Result := FEngine.WaitForSyncMsgEvent;
end;
