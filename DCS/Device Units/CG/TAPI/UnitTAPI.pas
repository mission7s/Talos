...
begin
  ...
  begin
    ...
    FTAP.FLastRecvData := String(pData);
...
begin
  ...
  FLastCommand  := TAP_COMMAND_NoMatch;
  FLastRecvData := '';
...
begin
  ...
  HR := FTAP.Connect(BOOL(ATCP), TBStr(AIP), APort, 0, FTAPEventHandler);
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.LoadPage(TBStr(AFileName), TBStr(APageName), AReturn);
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.LoadPage(TBStr(AFileName), TBStr(APageName));
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.UnloadPage(TBStr(APageName));
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.LoadProject(TBStr(AT3DFileName));
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.SaveProject(TBStr(AT3DFileName));
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.PreparePage(TBStr(APageName), ALayer, AAutoPreview);
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.SetObjValue(TBStr(APageName), TBStr(AObjName), TBStr(AValue), ATextImage);
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.SetText(TBStr(APageName), TBStr(AObjName), TBStr(ATextValue));
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.SetObjVisible(TBStr(APageName), TBStr(AObjName), AVisible);
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.SetObjAttr(TBStr(APageName), TBStr(AObjName), TBStr(AOptions));
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.SetPageDefault(TBStr(APageName));
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.SetBackground(TBStr(APageName), TBStr(ABgFileName));
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.SetPageEffect(TBStr(APageName), AIn, AEffectType, TBStr(AOptions));
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.SetPageEffectEx(TBStr(APageName), AIn, AEffectType, AFrameCount);
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.AddPause(TBStr(APageName), APauseFrame, ADelayFrame, AAutoResume);
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.DeletePause(TBStr(APageName), APauseFrame);
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.SetScrollSpeed(TBStr(APageName), ASpeed);
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.SetAudioFile(TBStr(APageName), AIn, TBStr(AAudioFileName));
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.SetAudioEnable(TBStr(APageName), AIn, AEnable);
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.SetStyleText(TBStr(APageName), TBStr(AObjName), AStyleID, TBStr(ATextValue));
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.SetImageObject(TBStr(APageName), TBStr(AObjName), AObjectID);
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.AddStyleText(TBStr(APageName), TBStr(AObjName), AStyleID, TBStr(ATextValue));
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.AddImageObject(TBStr(APageName), TBStr(AObjName), AObjectID);
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.AddScrollObject(TBStr(APageName), TBStr(AObjName));
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.CreateImageFile(TBStr(APageName), AImageWidth, AImageHeight, TBStr(AImagePathName));
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.QueryLoad(TBStr(APageName));
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.QueryPageMode(TBStr(APageName));
  if (Failed(HR)) then exit;

  Result := WaitForSyncMsgEvent;
  if (Result = T3D_TRUE) then
  begin
    L := LastDelimiter(' ', FLastRecvData);
    if (L > 0) then
      APageMode := Copy(FLastRecvData, L + 1, Length(FLastRecvData));
  end;
end;
...
begin
  ...
  HR := FTAP.QueryPageAlias(TBStr(APageName));
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.QueryAliasAll(TBStr(APageName));
  if (Failed(HR)) then exit;
...
begin
  ...
  HR := FTAP.QueryObjValue(TBStr(APageName), TBStr(AObjName));
  if (Failed(HR)) then exit;
