...
type
  ...
  public
    ...
    constructor Create(AServerIP: AnsiString; AServerPort: Word; ATimeout: Cardinal = 10000); overload; virtual;
  ...
  public
    ...
    constructor Create(ABus: TPCSSwitchBus; AEnabled: Boolean);
    destructor Destroy; override;
  end;
  ...
  public
    ...
    function SetTransitionType(ATypeName: String): Integer;
    function SetTransitionRate(ARateName: String; ARateFrames: Integer): Integer;
    ...
    function GetTransitionType(var ATypeName: String): Integer;
...
constructor TPCSBaseControl.Create(AServerIP: AnsiString; AServerPort: Word; ATimeout: Cardinal = 10000);
begin
  Create;
...
function TPCSMediaControl.GetTimecode(var ATimecode: String): Integer;
var
  JSONObejct: TJSONObject;
begin
...
begin
  ...
  try
    ...
    if (Result = D_OK) then
    begin
      FRecvJSONObject.TryGetValue('exist', AExist);
    end;
  finally
    FreeAndNil(JSONObejct);
  end;
...
function TPCSSwitcherControl.SetTransitionType(ATypeName: String): Integer;
var
  JSONObejct: TJSONObject;
begin
...
function TPCSSwitcherControl.GetTransitionType(var ATypeName: String): Integer;
var
  JSONObejct: TJSONObject;
begin
  ATypeName := '';
