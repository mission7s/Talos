...
var
  ...
  F: Integer;
begin
  DecodeTimeCode(ATC1, Hour1, Minute1, Second1, Frame1);
  DecodeTimeCode(ATC2, Hour2, Minute2, Second2, Frame2);
...
//  if (DropFrame) and (Frame1 = 0) and (Second1 = 0) and ((Minute1 mod 10) <> 0) then Frame1 := 2;
  if (ADropFrame) and (Second1 = 0) and ((Minute1 mod 10) <> 0) then
  begin
    Inc(Frame1, 2);
    if Frame1 >= 30 then
    begin
...
//  if (DropFrame) and (Frame1 = 0) and (Second1 = 0) and ((Minute1 mod 10) <> 0) then Frame1 := 2;
  if (ADropFrame) and (Frame1 = 0) and (Second1 = 0) and ((Minute1 mod 10) <> 0) then
  begin
    Dec(Frame1, 2);
    if Frame1 < 0 then
    begin
