...
function SECInputChannelCueSheet(AIP: PChar; ACueSheetFileName: PChar; AChannelID: Word; AOnairdate: PChar; AOnairFlag: TOnAirFlagType;
                                 AOnairNo, AEventCount, ALastSerialNo, ALastProgramNo, ALastGroupNo: Integer): Integer; stdcall; external SECDLL_NAME name 'SECInputChannelCueSheet';
function SECDeleteChannelCueSheet(AIP: PChar; AChannelID: Word; AOnairdate: PChar): Integer; stdcall; external SECDLL_NAME name 'SECDeleteChannelCueSheet';
function SECClearChannelCueSheet(AIP: PChar; AChannelID: Word): Integer; stdcall; external SECDLL_NAME name 'SECClearChannelCueSheet';
function SECFinishLoadCueSheet(AIP: PChar; AChannelID: Word; ACueSheetFileName: PChar): Integer; stdcall; external SECDLL_NAME name 'SECFinishLoadCueSheet';
