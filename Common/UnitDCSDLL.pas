...
function DCSSetControlChannel(AID: Word; AHandle: TDeviceHandle; AChannelID: Word): Integer; stdcall; external DCSDLL_NAME name 'DCSSetControlChannel';
...
function DCSIDRename(AID: Word; AHandle: TDeviceHandle; ASourceID, ATargetID: Pchar): Integer; stdcall; external DCSDLL_NAME name 'DCSIDRename';
function DCSIDDelete(AID: Word; AHandle: TDeviceHandle; AMediaID: Pchar): Integer; stdcall; external DCSDLL_NAME name 'DCSIDDelete';
